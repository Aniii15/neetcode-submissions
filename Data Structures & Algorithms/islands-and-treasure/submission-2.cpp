...
// the code is basically a slight tweak in the template at https://cp-algorithms.com/graph/breadth-first-search.html$0
...
public:
    void islandsAndTreasure(vector<vector<int>>& grid) {
        ...
        // This queue will hold the {row, col} coordinates of our cells with treasure (bfs sources) initially
        // then we populate it with points firther and further away from any given source (basically traditional bfs practice)
